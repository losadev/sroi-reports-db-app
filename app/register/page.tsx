...
import { Building2, Mail, ArrowRight, ChevronDown } from 'lucide-react';
      ...
      <div className="flex items-center justify-center h-full px-4">
        <div className="text-center">
          ...
          <p className="text-slate-600">
            Gracias, <span className="font-semibold">{form.orgName}</span>. Te hemos enviado un correo a{' '}
    ...
    <div className="flex items-center justify-center h-full px-4 py-8 overflow-y-auto">
      <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-xl shadow-lg p-8 sm:p-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Regístrate para acceder a los reportes SROI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label htmlFor="orgName" className="text-sm font-semibold text-slate-900 mb-2 block">
            ...
            {/* Tipo de entidad */}
            <div>
              <label htmlFor="entityType" className="text-sm font-semibold text-slate-900 mb-2 block">
                Tipo de entidad
              </label>
              <div className="relative">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Usaremos esta información de forma agregada para entender quién consulta y descarga los informes,
            así como para enviar comunicaciones relacionadas con medición de impacto y metodología SROI si
            la persona lo desea.
          </p>
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              />
              <span className="text-sm text-slate-700 group-hover:text-slate-900 transition-colors">
                Quiero recibir información sobre SROI (formaciones, recursos, servicios, etc.)
              </span>
            </label>
