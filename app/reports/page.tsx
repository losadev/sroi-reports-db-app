    ...
    <div className="flex h-full bg-gradient-to-br from-slate-50 via-white to-slate-50 overflow-hidden relative">
            ...
            <div className="space-y-2.5">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  name="accredited"
                  value="all"
                  checked={accredited === null}
                  onChange={() => { setAccredited(null); closeSidebarOnMobile(); }}
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  onChange={() => { setAccredited('true'); closeSidebarOnMobile(); }}
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  ...
                  name="accredited"
                  value="false"
                  checked={accredited === 'false'}
                  onChange={() => { setAccredited('false'); closeSidebarOnMobile(); }}
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-slate-200 bg-white">
          <div className="flex justify-end sm:justify-start sm:mb-4">
            <button
